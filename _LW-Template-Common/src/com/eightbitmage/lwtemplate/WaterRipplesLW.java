...
public class WaterRipplesLW extends LibdgxWallpaperApp implements
		InputProcessorLW {
	...
	Mesh mesh;
	Texture texture;
	Plane plane = new Plane(new Vector3(), new Vector3(1, 0, 0), new Vector3(0,
			1, 0));
	...
	public void create() {
		...
		camera = new PerspectiveCamera(90, Gdx.graphics.getWidth(),
